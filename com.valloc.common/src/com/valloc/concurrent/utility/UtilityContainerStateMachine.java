...
public class UtilityContainerStateMachine extends AbstractStateMachine
{
	private StateFactory stateFactory = new ThreadContainerStateFactory();
	private final UtilityContainer utilityContainer;
	
	/**
	 * @param utilityContainer
	 */
	UtilityContainerStateMachine(final UtilityContainer utilityContainer)
	{
		this.utilityContainer = utilityContainer;
		addStateChangeListener(utilityContainer); // implied and necessary
	...
	private final class UnassignedState extends AbstractState
	{
		...
		public void start()
		{
			final MessageSummary summary = utilityContainer.start();
	...
	private final class ActiveState extends AbstractState
	{
		...
		public void destroy()
		{
			final MessageSummary summary = utilityContainer.destroy();
			getStateMachine().setStateChangeMessageSummary(summary);
		}
		...
		public void kill()
		{
			final MessageSummary summary = utilityContainer.kill();
			getStateMachine().setStateChangeMessageSummary(summary);
		}
	}
