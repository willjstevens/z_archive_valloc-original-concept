 ...
 * @author wstevens
 */
//public class LocalUserServiceBase extends AbstractService implements LocalUserService
public class LocalUserServiceBase extends AbstractAgentService implements LocalUserService
{
	@Override
	public String name() {
