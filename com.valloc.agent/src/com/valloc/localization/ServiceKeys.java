...
{
	private static final String HOST_BUNDLE_SYMB_NAME		= AgentConstants.BUNDLE_ID_AGENT;
	private static final String BUNDLE_ITEM_ID				= AgentLocalizationConstants.BUNDLE_ID_SERVICE;
	...
	@Override
	public String name() {
		return AgentLocalizationConstants.BUNDLE_ID_SERVICE;
	}
