 ...
 * @author wstevens
 */
public class AgentCommandHandlerFlagsRepository extends CommonCommandHandlerFlagsRepository
{
	...
	public void initialize() {
		...
		for (AgentCommandHandlerFlags desktopFlagsObj : serverFlags) {
	...
	@Override
	AgentCommandHandlerFlags newFlags(final NodeType nodeType, final String serviceName, final String commandName) {
		return new AgentCommandHandlerFlags(new CommandHandlerFlagsKey(nodeType, serviceName, commandName));
	}
	 
	AgentCommandHandlerFlags[] serverFlags = {
